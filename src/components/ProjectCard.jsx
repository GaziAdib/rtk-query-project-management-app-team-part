...
const ProjectCard = ({ project }) => {
  ...
  return (
        searchedData ? (
            <div
        className="drop-shadow-xl border-dashed border-4 border-sky-600 relative flex flex-col items-start p-4 mt-3 bg-white rounded-lg cursor-pointer bg-opacity-90 group hover:bg-opacity-100"
        draggable="true"
    >
